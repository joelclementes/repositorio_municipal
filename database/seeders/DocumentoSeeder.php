        ...
        $documentos = [
            [
                'documento_data' => [
                    ...
                    'subcategoria_id' => 1,
                    'regla_presentacion' => 'todo_el_anio',
                    'formato' => 'PDF',
                ],
            ],
            [
            ...
            [
                'documento_data' => [
                    ...
                    'subcategoria_id' => 1,
                    'regla_presentacion' => 'dias_16_25_mes',
                    'formato' => 'XLSX,PDF',
                ],
            ],
            [
            ...
            [
                'documento_data' => [
                    'clave' => 'OBM4',
                    'nombre' => 'Reporte de Recaudación de Derechos de Agua',
                    'subcategoria_id' => 8,
                    'regla_presentacion' => 'dias_16_25_mes',
                    'formato' => 'PDF',
                ],
            ...
            [
                'documento_data' => [
                    ...
                    'subcategoria_id' => 9,
                    'regla_presentacion' => 'enero_abril',
                    'formato' => 'XLSX,PDF',
                ],
            ],
            [
                'documento_data' => [
                    ...
                    'subcategoria_id' => 9,
                    'regla_presentacion' => 'septiembre_15_30',
                    'formato' => 'XLSX,PDF',
                ],
            ],
            [
            ...
            [
                'documento_data' => [
                    ...
                    'subcategoria_id' => 9,
                    'regla_presentacion' => 'enero_1_a_marzo_31',
                    'formato' => 'PDF',
                ],
            ],
            [
            ...
            [
                'documento_data' => [
                    ...
                    'subcategoria_id' => 9,
                    'regla_presentacion' => 'trimestral_ene_abr_jul_oct_mes_completo',
                    'formato' => 'XLSX,PDF',
                ],
            ],
            [
