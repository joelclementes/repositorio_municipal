    ...
    public function run(): void
    {
        $avisos = [
            ...
            [
                ...
                'tipo_aviso' => 'Aviso',
                'texto' => 'Hacemos de su conocimiento la forma en que deberá remitir la Cuenta Pública 2025',
                'activo' => true,
                'url' => 'https://legisver.gob.mx/archivosAvisos/Presentaci%C3%B3n_de_la_Cuenta_P%C3%BAblica_2025.pdf',
                'archivo' => null,
                'fecha_publicacion' => now(),
                'fecha_expiracion' => now()->addDays(90),
                'creado_por' => 2,
