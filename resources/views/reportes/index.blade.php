                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        <div class="text-gray-600 text-sm">
                            Haz clic en el botón para generar el reporte general en formato Excel.
                        </div>
                        <a href="{{ route('reportes.export') }}" class="inline-flex items-center px-4 py-2 bg-[#6c143a] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#520f2c] focus:bg-[#520f2c] active:bg-[#3d0b21] focus:outline-none focus:ring-2 focus:ring-[#6c143a] focus:ring-offset-2 transition ease-in-out duration-150">
