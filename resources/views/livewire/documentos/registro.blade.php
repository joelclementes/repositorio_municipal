{{-- <div class="flex flex-col space-y-3 px-6 max-w-4xl mx-auto "> --}}
    <div>
        <div class="w-1/3 mx-auto mb-6">
            ...
            <select
                class="w-full px-3 py-2 text-sm border border-vino-900 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-vino-900 focus:border-vino-900 bg-white disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-500 transition-colors"
                name="subcategoria" wire:model.live="subcategoriaSeleccionada" {{ !$categoriaSeleccionada ? 'disabled' : '' }}>
            ...
            @if ($categoriaSeleccionada && $subcategoriaSeleccionada)
                <div class="mt-2 p-2 bg-green-50 border border-green-200 rounded-md text-xs text-green-700 flex items-center">
