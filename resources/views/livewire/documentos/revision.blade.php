            ...
            @if ($this->documentosRecibidos->isNotEmpty())
                ...
                <div class="space-y-4 max-h-[calc(100vh-300px)] overflow-y-auto pr-2">
                    @foreach ($this->documentosRecibidos as $documentoRecibido)
                        ...
                        {{-- Agrupador por documento (opcional, para mantener contexto) --}}
                        <div class="mb-2">
                            <div class="bg-gray-100 px-3 py-2 rounded-t-lg border border-gray-200 border-b-0">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <span
                                            class="text-sm font-semibold text-gray-700">{{ $documento->nombre }}</span>
                                    </div>
                            ...
                            <div
                                ...
                                <div class="border-t border-gray-200 bg-gray-50 px-4 py-3">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        @if ($estado_archivo === 'Rechazado' && auth()->user()->hasRole('Administrador'))
                                            <div class="relative group">
                                                <button type="button"
